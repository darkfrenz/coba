...
public class LoginActivity extends AppCompatActivity {
    ...
    private static String KEY_IMAGE_URL = "profileimage";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            Intent i = new Intent(LoginActivity.this, ActivityHomeSidebar.class);
            startActivity(i);
            finish();
        }
    ...
    private void forgotPasswordDialog() {
        ...
        View dialogView = inflater.inflate(R.layout.login_reset_password, null);
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        if(Integer.parseInt(json_user.getString("verified")) == 1){
                            db.addUser(json_user.getString(KEY_UID), json_user.getString(KEY_NAME), json_user.getString(KEY_EMAIL), json_user.getString(KEY_CREATED_AT), json_user.getString(KEY_USERNAME), json_user.getString(KEY_REGION), json_user.getString(KEY_PHONE), json_user.getString(KEY_SALDO), json_user.getString(KEY_IMAGE_URL));

                            Intent upanel = new Intent(LoginActivity.this, ActivityHomeSidebar.class);
                            ...
                            Intent upanel = new Intent(LoginActivity.this, LoginEmailVerify.class);
                            upanel.putExtras(b);
                            upanel.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(upanel);
                            finish();
                        ...
                        // Error in myvg. Get the error message
