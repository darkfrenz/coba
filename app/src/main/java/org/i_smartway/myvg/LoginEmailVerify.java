 ...
 * www.i_smartway.org
 */
public class LoginEmailVerify extends AppCompatActivity {
    private static final String TAG = LoginEmailVerify.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.login_email_verify);
    ...
    private void init() {
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Hide Keyboard
                Functions.hideSoftKeyboard(LoginEmailVerify.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent upanel = new Intent(LoginEmailVerify.this, LoginHomeActivity.class);
